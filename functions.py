...
#     # cookies = mr.bypass_cf(siteGet)
#     # change proxy account
#     res = mr.req.get(sitePost)
#     cookies = res.cookies.get_dict()
#     cookies[
#         "source"] = "ucp.nordvpn.com%26campaign%3D%26medium%3Dreferral%26term%3D%26content%3D%26hostname%3Ducp.nordvpn.com%26pathname%3D/dashboard/%26date%3D20200219"
#     cookies["__zlcmid"] = "wjiuVIqZPg5iQi"
#     cookies["locale"] = "it"
#     cookies["nord_countdown"] = "1581640224388"
#     mr.set_random_user_agent()
#     mr.set_random_proxy()
#     # print(mr.req.get("https://www.whatismyip.com/").content)
#     res = mr.post_with_checks(sitePost,
#                               data={"username": usr, "password": pwd}, cookies=cookies)
#     print(res)
#     print(res.headers)
